...
public class DocumentCrudInternalService {
    ...
    public DocumentCrudInternalService(RepoDocument repoDocument, HazelCastUtility hazelCastUtility, DocInfoProxy docInfoProxy, DocElasticProxy docElasticProxy, ProxyApplicant proxyApplicant, ProxyDocType proxyDocType, com.aris.ESD_Document.proxy.ProxyDepartment proxyDepartment) {
...
//            document.setDocumentCode(docCode);
            ...
            if (responseApplicant.getApplicant() != null) {
                if (responseApplicant.getApplicant().getIsKollektiv() == 0 && responseDocType.getDocumentMovByidDocumentType().getIdDocumentType() == 2
                        || responseDocType.getDocumentMovByidDocumentType().getIdDocumentType() == 3) {
                    logger.info("responseApplicant.getApplicant().getIsKollektiv() == 0 &&responseDocType.getDocumentMovByidDocumentType().getIdDocumentType()==2\n" +
                            "                        &&responseDocType.getDocumentMovByidDocumentType().getIdDocumentType()==3", responseApplicant.getApplicant().getIsKollektiv());
                    String s = "";
//                    String s = responseApplicant.getApplicant().getIdApplicant() + "";
                    String docIDForCode = document.getIdDocument() + "";
...
//                Milli meclis huqiqi ve sened
                else if (responseApplicant.getApplicant().getIsKollektiv() == 0 && responseDocType.getDocumentMovByidDocumentType().getIdDocumentType() == 5
...
//                Nazirler kabineti huquqi sened
                else if (responseApplicant.getApplicant().getIsKollektiv() == 0 && responseDocType.getDocumentMovByidDocumentType().getIdDocumentType() == 8
                ...
                else if (responseApplicant.getApplicant().getIsKollektiv() == 0 && responseDocType.getDocumentMovByidDocumentType().getIdDocumentType() == 11
...
//                PA -nin huquqi ve xidmeti kollektiv olmasi
                else if (responseApplicant.getApplicant().getIsKollektiv() == 1 && responseDocType.getDocumentMovByidDocumentType().getIdDocumentType() == 2
                        || responseDocType.getDocumentMovByidDocumentType().getIdDocumentType() == 3) {
                    logger.info("----------HazelCastUtility---------responseApplicant.getApplicant().getIsKollektiv() :{}", responseApplicant.getApplicant().getIsKollektiv());
                    String s = "";
                    String docIDForCode = document.getIdDocument() + "";
                ...
                else if (responseApplicant.getApplicant().getIsKollektiv() == 1 && responseDocType.getDocumentMovByidDocumentType().getIdDocumentType() == 5
                        || responseDocType.getDocumentMovByidDocumentType().getIdDocumentType() == 6) {
                    logger.info("----------HazelCastUtility---------responseApplicant.getApplicant().getIsKollektiv() :{}", responseApplicant.getApplicant().getIsKollektiv());
                    String s = "";
                    String docIDForCode = document.getIdDocument() + "";
                ...
                else if (responseApplicant.getApplicant().getIsKollektiv() == 1 && responseDocType.getDocumentMovByidDocumentType().getIdDocumentType() == 8
                        || responseDocType.getDocumentMovByidDocumentType().getIdDocumentType() == 9) {
                    logger.info("----------HazelCastUtility---------responseApplicant.getApplicant().getIsKollektiv() :{}", responseApplicant.getApplicant().getIsKollektiv());
                    String s = "";
                    String docIDForCode = document.getIdDocument() + "";
                ...
                else if (responseApplicant.getApplicant().getIsKollektiv() == 1 && responseDocType.getDocumentMovByidDocumentType().getIdDocumentType() == 11
                        || responseDocType.getDocumentMovByidDocumentType().getIdDocumentType() == 12) {
                    logger.info("----------HazelCastUtility---------responseApplicant.getApplicant().getIsKollektiv() :{}", responseApplicant.getApplicant().getIsKollektiv());
                    String s = "";
                    String docIDForCode = document.getIdDocument() + "";
...
//            }
            ...
            // kadr emr
                    ...
                    responseApplicant.getApplicant() == null &&
...
//            qerar
    ...
    public DocumentResponse saveDocElastic(Document document) {
        ...
        try {
            ...
            requestDocElastic.setDoc(docInfo.getDocument());
